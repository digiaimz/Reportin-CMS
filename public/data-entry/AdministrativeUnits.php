...
<h2 style="margin-top:20px; text-align:left;">
	Administrative Units Print Report
...
$pno++;
//-----------------------------------------------------------------------
echo'<h1 style="text-align:left;margin-top:50px;margin-bottom:30px;">'.$pno.' - '.$rowstd['prov_name'].' </h1>';
//-----------------------------------------------------------------------
if($rowstd['id_prov']){
//-----------------------------------------------------------------------
	$sqllmsDivisions  = $dblms->querylms("SELECT *  
										FROM ".DIVISIONS."  
										WHERE id_prov = '".$rowstd['id_prov']."' 
...
$dno++;
//-----------------------------------------------------------------------
echo'<h1 style="text-align:left;margin-left:50px;color:red;">'.$dno.' - '.$rowDivisions['div_name'].' </h1>';
//-----------------------------------------------------------------------
}
//-----------------------------------------------------------------------
