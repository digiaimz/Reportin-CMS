...
<script>
const svg = document.getElementById('reload');
...
margin: 0px;
                ...
                <div class="col-xl-12 col-lg-12 col-sm-12   ">
                    <div class="widget-content   widget-content-area  br-6">
                        ...
                        <div class="row  ">
                        <div class="col-xl-10 col-lg-10 col-sm-12   col-md-10   ">
         ...
         dom: '<"row"<"col-md-12"<"row"<"col-md-4"B><"col-md-4"l><"col-md-4"f> > ><"col-md-12"rt> <"col-md-12"<"row"<"col-md-5"i><"col-md-7"p>>> >',
           ...
           type: 'GET',
            ...
            "createdRow": function( row, data, dataIndex ) {
                ...
                $(row).attr("data-forum", data.id_forum);
