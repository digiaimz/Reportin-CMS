                ...
                <div class="widget-content widget-content-area">
                    ...
                    <div class="text-center ">
                        ...
                        <div class="avatar avatar-lg avatar-indicators avatar-online">
                            <img alt="avatar" style="    max-width: 140px;" src="{{asset('dawa_theme/assets/img/user.png')}}" class="rounded-circle">
                        </div>
                        <br>
...
<ul class="nav nav-tabs  mb-3 mt-3" id="simpletab" role="tablist">
    ...
    <li class="nav-item">
        <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">2021</a>
    </li>
    
    <li class="nav-item">
        <a class="nav-link  " id="hometwo-tabs" data-toggle="tab" href="#hometwo" role="tab" aria-controls="hometwo" aria-selected="true" >2022</a>
    </li>
    <li class="nav-item">
        <a class="nav-link  " id="homethree-tabs" data-toggle="tab" href="#homethree" role="tab" aria-controls="homethree" aria-selected="true" >2023</a>
    </li>
    <li class="nav-item">
        <a class="nav-link  " id="homefour-tabs" data-toggle="tab" href="#homefour" role="tab" aria-controls="homefour" aria-selected="true" >2024</a>
    </li>
    <li class="nav-item">
...
<div class="tab-content" id="simpletabContent">
    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
        ...
        @include('dawa_theme.workers.include.table')
