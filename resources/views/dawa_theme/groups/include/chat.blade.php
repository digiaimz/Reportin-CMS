                ...
                <div class="chat-system">
                    ...
                    <div class="user-list-box">
                        ...
                        <div class="people">
                            ...
                            <div class="person" data-chat="person6">
                                <div class="user-info">
                                    <div class="f-head">
                                        <img src="{{asset('dawa_theme/assets/img/profile-4.jpg')}}" alt="avatar">
                                    </div>
                                    <div class="f-body">
                                        <div class="meta-info">
                            ...
                            <div class="person" data-chat="person1">
                                <div class="user-info">
                                    <div class="f-head">
                                        <img src="{{asset('dawa_theme/assets/img/profile-3.jpg')}}" alt="avatar">
                                    </div>
                                    <div class="f-body">
                                        <div class="meta-info">
                            ...
                            <div class="person" data-chat="person2">
                                <div class="user-info">
                                    <div class="f-head">
                                        <img src="{{asset('dawa_theme/assets/img/profile-11.jpg')}}" alt="avatar">
                                    </div>
                                    <div class="f-body">
                                        <div class="meta-info">
                            ...
                            <div class="person" data-chat="person3">
                                <div class="user-info">
                                    <div class="f-head">
                                        <img src="{{asset('dawa_theme/assets/img/profile-23.jpg')}}" alt="avatar">
                                    </div>
                                    <div class="f-body">
                                        <div class="meta-info">
                            ...
                            <div class="person" data-chat="person4">
                                <div class="user-info">
                                    <div class="f-head">
                                        <img src="{{asset('dawa_theme/assets/img/profile-7.jpg')}}" alt="avatar">
                                    </div>
                                    <div class="f-body">
                                        <div class="meta-info">
                            ...
                            <div class="person" data-chat="person5">
                                <div class="user-info">
                                    <div class="f-head">
                                        <img src="{{asset('dawa_theme/assets/img/profile-15.jpg')}}" alt="avatar">
                                    </div>
                                    <div class="f-body">
                                        <div class="meta-info">
                            ...
                            <div class="person" data-chat="person7">
                                <div class="user-info">
                                    <div class="f-head">
                                        <img src="{{asset('dawa_theme/assets/img/profile-32.jpg')}}" alt="avatar">
                                    </div>
                                    <div class="f-body">
                                        <div class="meta-info">
                            ...
                            <div class="person" data-chat="person8">
                                <div class="user-info">
                                    <div class="f-head">
                                        <img src="{{asset('dawa_theme/assets/img/profile-33.jpg')}}" alt="avatar">
                                    </div>
                                    <div class="f-body">
                                        <div class="meta-info">
                            ...
                            <div class="person" data-chat="person9">
                                <div class="user-info">
                                    <div class="f-head">
                                        <img src="{{asset('dawa_theme/assets/img/profile-21.jpg')}}" alt="avatar">
                                    </div>
                                    <div class="f-body">
                                        <div class="meta-info">
                            ...
                            <div class="person" data-chat="person10">
                                <div class="user-info">
                                    <div class="f-head">
                                        <img src="{{asset('dawa_theme/assets/img/profile-12.jpg')}}" alt="avatar">
                                    </div>
                                    <div class="f-body">
                                        <div class="meta-info">
                            ...
                            <div class="person" data-chat="person11">
                                <div class="user-info">
                                    <div class="f-head">
                                        <img src="{{asset('dawa_theme/assets/img/profile-26.jpg')}}" alt="avatar">
                                    </div>
                                    <div class="f-body">
                                        <div class="meta-info">
                            ...
                            <div class="person border-none" data-chat="person12">
                                <div class="user-info">
                                    <div class="f-head">
                                        <img src="{{asset('dawa_theme/assets/img/profile-20.jpg')}}" alt="avatar">
                                    </div>
                                    <div class="f-body">
                                        <div class="meta-info">
                    ...
                    <div class="chat-box">
                        ...
                        <div class="overlay-phone-call">
                            <div class="">
                                ...
                                <div class="calling-user-img">
                                    <div class="">
                                        <img src="{{asset('dawa_theme/assets/img/90x90.jpg')}}" alt="dynamic-image">
                                    </div>
                        ...
                        <div class="overlay-video-call">
                            <img src="{{asset('dawa_theme/assets/img/video-chat.jpg')}}" class="video-caller" alt="video-chat">
                            <div class="">
                                <div class="calling-user-info">
                                    <div class="d-flex">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-arrow-left-circle go-back-chat"><circle cx="12" cy="12" r="10"></circle><polyline points="12 8 8 12 12 16"></polyline><line x1="16" y1="12" x2="8" y2="12"></line></svg>
                        ...
                        <div class="chat-box-inner">
                            <div class="chat-meta-user">
                                <div class="current-chat-user-name"><span><img src="{{asset('dawa_theme/assets/img/90x90.jpg')}}" alt="dynamic-image"><span class="name"></span></span></div>
