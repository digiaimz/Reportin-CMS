                                ...
                                <td>
                                    <div class="d-flex">
                                        <div class="usr-img-frame mr-2 rounded-circle">
                                            <img alt="avatar" class="img-fluid rounded-circle" src="{{asset('dawa_theme/assets/img/boy.png')}}">
                                        </div>
                                    </div>
                                </td>
                                <td><span class="shadow-none badge badge-success">Active</span></td>
                                <td>
                                    <a href="{{route('edit.province',['slug'=>'slug'])}}" class="bs-tooltip" data-toggle="tooltip" 
