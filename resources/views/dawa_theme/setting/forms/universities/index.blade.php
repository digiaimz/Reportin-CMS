        ...
        <div class="col-xl-4 col-lg-4 col-md-2  col-sm-12  layout-spacing">
            <div class="widget-content widget-content-area br-6">
                <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                 <center>   <h4>Add New University</h4>
                 </center>
                </div>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Add New University</h5>
            ...
            <div class="modal-body">
                <p class="modal-text">
                    ...
                    <div class=" ">
                        ...
                        <div class="col-xl-6 col-md-6 col-sm-12 col-6 mb-3">
                            <label for="exampleFormControlSelect1">University Code:</label>
                            <div class="input-group input-group-sm  ">
                    ...
                    <table id="html5-extension" class="table table-hover non-hover" style="width:100%">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('edit.University',['slug'=>'slug'])}}" class="bs-tooltip" data-toggle="tooltip" 
