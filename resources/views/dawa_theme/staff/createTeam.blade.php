...
@endif
                ...
                <div class="row layout-top-spacing"   style="display: block;  ">
                    ...
                    <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                        ...
                        <?php
    //  $designations = \App\Designation::with('forum', 'worker' , 'permissions')->where('level', Auth::user()->access_type      )
    //                             ->whereIN('forum_id' ,\App\Helpers\Helper::get_forums_access())->orderby('order_by' , 'DESC') ->orderBy('forum_id', 'DESC')->get();
     $designations = \App\Designation::with('forum', 'worker' , 'permissions')->where('level', Auth::user()->access_type      )
                                ->where('forum_id' , Auth::user()->id_forum)->orderby('order_by' , 'DESC') ->orderBy('forum_id', 'DESC')->get();
       ...
       $filled_seat = 0;
                        ...
                        <div class="form-body" style="text-align: center;">
                            <h3 class="box-title m-t-40" style="text-align:center;"><b>My Level Tanzimi Body</b></h3>
...
$flag = in_array(6 , $permissions_ ) ;
 ?>
                                    ...
                                    @if(  Auth::user()->access_type  == "Admin"  ||  Auth::user()->access_type  == "Markazi")
                                ...
                                $zones = explode(",",Auth::user()->access_level);
                                       ?>
                                ...
                                @endforeach
                                     ...
                                     $districts = explode(",",Auth::user()->access_level);
                                            ?>
                                    ...
                                    ?>
                                     ...
                                     $tehsils = explode(",",Auth::user()->access_level);
                                            ?>
...
@include('dawa_theme.sidebar.bottom' , ['bottom_active' => 'tanzim'])
