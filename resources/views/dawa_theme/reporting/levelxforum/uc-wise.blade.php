        ...
        <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
            ...
            <div class="widget-content widget-content-area br-6">
                ...
                <div class="row">
                    ...
                    function gotoPage()
                    {
                         window.location = "{{route('reporting.uc.wise')}}/"+$('#district_id').val();
                    }
...
font-size: 29px;
font-weight: 700;">UC-Wise Summary   </h6>
<?php
...
?>
                ...
                <table id="reporting_table"   style="width:100%;text-align:center; font-size: 18px;font-family: Calibri;" border="1"  cellpadding="9">
                    ...
                    <tbody>
                        ...
                        @foreach (\App\UC::with('wabastas', 'workers' )->where('id_tsl' , $id)->orderBy('uc_name_eng')->get() as $uc )
                        ...
                        <tr>
                            ...
                            <th rowspan="2">
                                ...
                                <span data-name="{{$uc->uc_name_eng}}" class="badge badge-light view-graph mt-2" >
                        ...
                        $uc_workers = $uc->workers->filter(function ($value, $key)use($forum) {
                    ...
                    <tr  style="background-color: rgb(117 116 116 / 10%);">
                        ...
                        $uc_wabastas = $uc->wabastas->filter(function ($value, $key)use($forum) {
