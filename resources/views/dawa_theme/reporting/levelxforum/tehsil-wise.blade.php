        ...
        <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
            ...
            <div class="widget-content widget-content-area br-6">
                ...
                <div class="row">
                    ...
                    function gotoPage()
                    {
                         window.location = "{{route('reporting.tehsil.wise')}}/"+$('#district_id').val();
                    }
...
?>
    ...
    <option  @if($district->id_dist  == $id) selected @endif value="{{$district->id_dist  }}"> {{ $district->dist_name }} </option>
