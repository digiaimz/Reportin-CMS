...
@endsection
{{-- dashboard_aria --}}
@section('zone_wise_aria') aria-expanded="true" @endsection
{{-- title --}}
@section('title')
Zone-Wise Summery
@endsection
...
font-size: 29px;
font-weight: 700;">Zone-Wise Summery</h6>
...
{
    $zones =  \App\Zone::with('wabastas' , 'workers')->orderBy('zone_name')
                        ->whereIN('id_zone' , \App\Helpers\Helper::getLevelIds('Zone') )
                        ->get();
}
else{
    $zones =  \App\Zone::with('wabastas' , 'workers')->orderBy('zone_name')
                        ->get();
                         ...
                         {{-- start zone foreach loop  time is equal to n --}}
                        ...
                        <tr>
                            ...
                            ?>
                            <th rowspan="2">
                                <a target="_blank" href="{{route('reporting.district.wise' , ['id'=> $zone->id_zone])}}">
                                {{ $zone->zone_name }}
                            </a>
                        <br>

                        <span data-name="{{$zone->zone_name}}" class="badge badge-light view-graph mt-2" >
                        ...
                        View Graph
                            ...
                            $i=0;
                            ?>
                               {{-- start forum foreach loop  time is equal to n * n --}}
                        @foreach ($forums as $forum )

                        <?php

                        $zone_workers = $zone->workers->filter(function ($value, $key)use($forum) {
                        ...
                        $total_count = count($zone_workers);
                        ...
                        @endforeach
                                 {{-- end forum foreach loop  time is equal to n * n --}}
                        <?php
...
$zone_wabastas = $zone->wabastas->filter(function ($value, $key)use($forum) {
...
$total_count = count($zone_wabastas);
 $total =     $total +    $total_count ;
...
?>
                        ...
                        @endforeach
         {{-- end zone foreach loop  time is equal to n   --}}
                        ...
                        border-left: 2px solid black;">
                            ...
                            <th rowspan="2">
                                ...
                                <span data-name="All Zones" class="badge badge-light view-graph mt-2" >
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-activity"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"></polyline></svg>

                            </th>
                            <th> @lang('Workers') </th>
                         {{-- start array foreach loop  time is equal to n  --}}
                        ...
                        @endforeach
                      {{-- end array foreach loop  time is equal to n  --}}
                    </tr>
...
<br>
                <div class="row">
                    ...
                    <div class="col-md-4" style="border: 1px solid #80808033;padding:10px; 0px">
                        ...
                        <h6 style="   text-align:center; font-weight: 700;">Zone: <span class="name_of_selection"></span></h6>
