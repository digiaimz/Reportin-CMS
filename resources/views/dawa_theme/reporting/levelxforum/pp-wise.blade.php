...
@endsection
{{-- dashboard_aria --}}
@section('tehsil_wise_aria') aria-expanded="true" @endsection
{{-- title --}}
@section('title')
PP-Wise Summery
@endsection
        ...
        <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
            ...
            <div class="widget-content widget-content-area br-6">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-6 col-md-6 col-sm-12  " style="padding: 0px;" >
                                <nav class="breadcrumb-two" aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item "><a href="{{route('reporting.district.wise')}}">

                                            @lang('District Summary')
                                        </a></li>
                                        <li class="breadcrumb-item "><a href="{{route('reporting.tehsil.wise')}}">

                                            @lang('Tehsil Summary')
                                        </a></li>

                                        <li class="breadcrumb-item active" aria-current="page"><a href="javascript:void(0);" style="    color: #007bff;">
                                            @lang('PP Summary') </a></li>
                                    </ol>
                                </nav>
                    </div>
                    <div class="col-xl-6 col-md-6 col-sm-12  " style="padding: 0px; ">
                    ...
                    function gotoPage()
                    {
                         window.location = "{{route('reporting.pp.wise')}}/"+$('#district_id').val();
                    }

                    </script>

<select id="district_id" onchange="gotoPage()" class="select">
...
if($tehsil->id_tsl   == $id)
{
   ...
   $name = $tehsil->tsl_name;
}

?>

    <option  @if($tehsil->id_tsl  == $id) selected @endif value="{{$tehsil->id_tsl  }}"> {{ $tehsil->tsl_name }} </option>
...
font-size: 29px;
font-weight: 700;">Tehsil-Wise Summary   </h6>
<?php
...
?>
                ...
                <table id="reporting_table"   style="width:100%;text-align:center; font-size: 18px;font-family: Calibri;" border="1"  cellpadding="9">
                    ...
                    <tbody>
                        ...
                        @foreach (\App\Tehsil::with('wabastas', 'workers' )->withcount('ucs')->where('id_dist' , $id)->orderBy('tsl_name')->get() as $tehsil )
                        ...
                        <tr>
                            ...
                            ?>
                            <th rowspan="2">
                                @if($tehsil->ucs_count > 0)
                                <a target="_blank"  href="{{route('reporting.uc.wise' , ['id'=> $tehsil->id_tsl ])}}">
                                {{ $tehsil->tsl_name }}
                            ...
                            @endif
                                ...
                                <span data-name="{{$tehsil->tsl_name}}" class="badge badge-light view-graph mt-2" >
                        ...
                        $tehsil_workers = $tehsil->workers->filter(function ($value, $key)use($forum) {
                        ...
                        $total_count = count($tehsil_workers);
                    ...
                    <tr  style="background-color: rgb(117 116 116 / 10%);">
                        ...
                        $tehsil_wabastas = $tehsil->wabastas->filter(function ($value, $key)use($forum) {
                        ...
                        $total_count = count($tehsil_wabastas);
                         $total =     $total +    $total_count ;
                    ...
                    $i++;
                        ...
                        border-left: 2px solid black;">
                            ...
                            <th rowspan="2">
                                ...
                                <span data-name=" Of {{ $name }} District" class="badge badge-light view-graph mt-2" >
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-activity"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"></polyline></svg>
...
<br>
            <div class="row">
                ...
                <div class="col-md-4" style="border: 1px solid #80808033;padding:10px; 0px">
                    ...
                    <h6 style="   text-align:center; font-weight: 700;">Tehsil: <span class="name_of_selection"></span></h6>
